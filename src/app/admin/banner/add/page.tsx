...
import { createBanner } from '../../../../lib/api/auth'; // Import the updated function
...
export default function AddBannerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Upload banner image using the updated createBanner function
      const response = await createBanner(imageFile as File);
